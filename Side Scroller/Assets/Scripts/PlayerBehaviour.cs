...
public class PlayerBehaviour : MonoBehaviour {
	...
	void CheckGrounded()
	{
		//Check if the player is hitting osmething from
		//the center of the object (origin) to slightly below the bottom of it (distance)
		float distance = (GetComponent<CapsuleCollider>().height / 2 * this.transform.localScale.y) + 0.1f;
